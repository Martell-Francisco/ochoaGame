...
function drawGameOver(){
    ...
    ctx.fillStyle = 'black';
    ctx.fillText('GAME OVER, Your score is: ' + score, canvas.width*.5, canvas.height*.5);
    ctx.fillStyle = 'white';
    ctx.fillText('GAME OVER, Your score is: ' + score, canvas.width*.5+5, canvas.height*.5+5);
}
